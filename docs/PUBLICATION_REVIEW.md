...
The public repository and English README were checked without authentication. The Windows ZIP was downloaded anonymously and its SHA-256 matched the original validated package. The private history backup returned HTTP 404 to an anonymous request; the old private commit was not available from the public repository (HTTP 422). The backup remains private and archived.
