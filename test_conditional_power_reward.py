...
from test_combat_survival_regressions import card, CardType
from spirecomm.spire.screen import CardRewardScreen

FRAME = json.loads((Path(__file__).parent / "test_fixtures/conditional_power_reward.json").read_text(encoding="utf-8"))
