...
from test_terminal_survival import game_for
from test_agent_policy import GameStub, build_card, strike, defend
from spirecomm.ai.agent import SimpleAgent
from spirecomm.spire.card import CardType
from spirecomm.spire.character import PlayerClass
from spirecomm.spire.relic import Relic

FRAMES = json.loads((Path(__file__).parent / "test_fixtures/strength_readiness_frames.json").read_text(encoding="utf-8"))
